/*
 * $Id: JGraphSQLQueryPane.java,v 1.1.1.1 2005/08/06 05:26:45 gaudenz Exp $
 * 
...
public class JGraphSQLQueryPane extends JPanel {
	...
	public JGraphSQLQueryPane(final UserDrawDataFlow adapter,
			final JGraph graph) {
