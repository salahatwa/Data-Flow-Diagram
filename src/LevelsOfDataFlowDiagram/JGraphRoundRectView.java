			...
			if (super.isOpaque()) {
				...
				g.fillRoundRect(b / 2, b / 2, d.width - (int) (b * 1.5),
						d.height - (int) (b * 1.5), roundRectArc, roundRectArc);
                                ...
                                g.drawLine(b / 2, b+40 / 2,b+300 / 2,b+40 / 2);
                                g.drawString(String.valueOf(getI()).substring(0,3), b+74 / 2, b+25 / 2);
                                name=String.valueOf(i).substring(0,3);
                                Double o=Double.parseDouble(name);
                                setI(o);
                                
                                if(getI()==1.0||getI()==2.0||getI()==3.0||getI()==4.0)
                                {
                                setI(getI() + 1.0);
                                }
                                else if(getI()==1.1||getI()==1.2||getI()==1.3||getI()==1.4)
                                {
